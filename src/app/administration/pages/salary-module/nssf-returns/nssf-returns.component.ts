...
@Component({
  selector: 'app-nssf-returns',
  templateUrl: './nssf-returns.component.html',
  styleUrls: ['./nssf-returns.component.scss']
})
export class NssfReturnsComponent implements OnInit, OnDestroy {
  title = 'export-table-data-to-any-format';
  displayedColumns: string[] = ['id','emp_no','first_name','other_names','id_no','nssf_no','period_m','period_y',
  'salary',
  'nssf',
];
