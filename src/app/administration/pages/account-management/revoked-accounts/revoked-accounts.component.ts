...
@Component({
  selector: 'app-revoked-accounts',
  templateUrl: './revoked-accounts.component.html',
  styleUrls: ['./revoked-accounts.component.scss']
})
export class RevokedAccountsComponent implements  OnInit, OnDestroy {
  rolesArray: any = [
    'ROLE_ADMIN',
	  'ROLE_USER',
    'ROLE_DIRECTOR',
  ...
  getRevokedAccounts(){
    this.authAPI.GetAllRevokedAccounts().subscribe( data =>{
