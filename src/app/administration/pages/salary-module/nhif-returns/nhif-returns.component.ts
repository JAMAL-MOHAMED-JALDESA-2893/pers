...
@Component({
  selector: 'app-nhif-returns',
  templateUrl: './nhif-returns.component.html',
  styleUrls: ['./nhif-returns.component.scss']
})
export class NhifReturnsComponent implements OnInit, OnDestroy {
  title = 'export-table-data-to-any-format';
  displayedColumns: string[] = ['id','emp_no','first_name','other_names','id_no','nhif_no','period_m','period_y',
  'salary',
  'nhif',
];
