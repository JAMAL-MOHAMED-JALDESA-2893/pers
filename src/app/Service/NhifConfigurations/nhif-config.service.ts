...
export class NhifConfigService {

  headers = new HttpHeaders().set('Content-Type', 'application/json');
    // API endpoint
  baseURL = `${environment.apiUrl}/api/v1/configurations/nhif`;
    constructor(private http: HttpClient) { }
  // Add
  createNhif(data: any): Observable<any> {
  ...
  getNhifById(id: any): Observable<any> {
  ...
  updateNhif(id: any, data: any): Observable<any> {
  ...
  // Delete Property
  deleteNhif(id: any): Observable<any> {
