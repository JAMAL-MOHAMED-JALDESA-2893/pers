...
export class AuthService {
  ...
  createAccount(data: User): Observable<any> {
    let API_URL = `${environment.apiUrl}/api/auth/signup/`;
...
login(username: string, password: string): Observable<any> {
  ...
  GetAllAccounts(): Observable<any> {
    let API_URL = `${environment.apiUrl}/api/auth/all/employees/accounts`;
    ...
    GetAllPendingAccounts(): Observable<any> {
      let API_URL = `${environment.apiUrl}/api/auth/all/pending/employees/accounts`;
      return this.http.get(API_URL, { headers: this.headers, withCredentials: false })
        .pipe(
          map((res) => {
    ...
    GetAllApprovedAccounts(): Observable<any> {
      let API_URL = `${environment.apiUrl}/api/auth/all/approved/employees/accounts`;
      return this.http.get(API_URL, { headers: this.headers, withCredentials: false })
        .pipe(
          map((res) => {
            console.log("hey data", res)
    ...
    GetAllRevokedAccounts(): Observable<any> {
      let API_URL = `${environment.apiUrl}/api/auth/all/revoked/employees/accounts`;
      return this.http.get(API_URL, { headers: this.headers, withCredentials: false })
        .pipe(
          map((res) => {
            console.log("hey data", res)
  ...
  GetAccountsByEmail(email:any): Observable<any> {
    ...
    let API_URL = `${environment.apiUrl}/api/auth/find/accounts/${email}`;
    return this.http.get(API_URL, { headers: this.headers, withCredentials: false })
      .pipe(
        map((res) => {
          return res || {}
...
return localStorage.getItem('jwtToken');
  ...
  logout() {
    ...
    updateRole(params: any): Observable<any> {
      let API_URL = `${environment.apiUrl}/api/auth/update/role/`;
    ...
    approveEmployee(params: any): Observable<any> {
      let API_URL = `${environment.apiUrl}/api/auth/approve/account/by/employee/`;
      return this.http.put(API_URL, {}, { params: params, headers: this.headers, withCredentials: false })
        .pipe(
          catchError(this.errorMgmt)
        )
    ...
    revokeEmployee(params: any): Observable<any> {
      let API_URL = `${environment.apiUrl}/api/auth/revoke/account/by/employee/`;
      return this.http.put(API_URL, {}, { params: params, headers: this.headers, withCredentials: false })
        .pipe(
          catchError(this.errorMgmt)
        )
