...
@Component({
  selector: 'app-inactive-employee-leaves',
  templateUrl: './inactive-employee-leaves.component.html',
  styleUrls: ['./inactive-employee-leaves.component.scss']
})
export class InactiveEmployeeLeavesComponent implements OnInit, OnDestroy {
