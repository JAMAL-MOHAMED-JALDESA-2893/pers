...
@Component({
  selector: 'app-make-leave-request',
  templateUrl: './make-leave-request.component.html',
  styleUrls: ['./make-leave-request.component.scss']
})
export class MakeLeaveRequestComponent implements OnInit, OnDestroy {
