...
@Component({
  selector: 'app-update-my-leave',
  templateUrl: './update-my-leave.component.html',
  styleUrls: ['./update-my-leave.component.scss']
})
export class UpdateMyLeaveComponent implements OnInit {
